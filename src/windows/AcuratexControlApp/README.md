...
App `C# WinForms` para operar el `ESP32-S3` por:
...
- `Presentation`: formularios y estado visual.
- `Application`: contratos y coordinacion de conexion.
- `Infrastructure`: transportes `TCP/WinUSB` y acceso nativo a Windows.
- `Shared`: modelos, constantes y defaults.
